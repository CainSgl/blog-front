...
import GradientBackground from '@/components/loginModal/children/common/GradientBackground.vue'
import StepUsername from './components/StepUsername.vue'
...
import StepNickname from './components/StepNickname.vue'
import api from '@/api'
